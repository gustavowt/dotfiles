...
- For each suggested commit, list the files to include and provide:
  - A short, specific title (max 72 chars). Do NOT use conventional commit prefixes like feat:, fix:, chore:, refactor:, etc.
  - A concise body: one or two short sentences max. No bullet points, no change lists. Just a clear description of what changed and why.
...
- Do not add Co-Authored-By, generated by, or any AI attribution messages.
